...
public class MainActivityViewModel extends AndroidViewModel {
    ...
    public void saveToFavorite(String uidUser, AnnoncePhotos annoncePhotos) {
        this.firebaseAnnonceRespository.saveAsFavorite(uidUser, getApplication().getApplicationContext(), annoncePhotos);
    }
}
